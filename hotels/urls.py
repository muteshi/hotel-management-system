...
urlpatterns = [
    ...
    path('hotels/conference/<slug:slug>', ConferenceHotelsDetailView.as_view(), name='conference-hotel-detail'),
    ...
    path('hotels/conferenceroom/new', views.new_conferenceroom, name='conferenceroom-create'),
    ...
    path('hotels/conferenceroom/<int:pk>/update/', ConferenceRoomUpdateView.as_view(), name='conferenceroom-update'),
    ...
    path('hotels/packages/honeymoon/', views.package_honeymoon_list, name='package_honeymoon_list'),
    path('hotels/packages/easter/', views.package_easter_list, name='package_easter_list'),
    path('hotels/packages/christmas/', views.package_christmas_list, name='package_christmas_list'),
    path('hotels/packages/coast/', views.package_coast_list, name='package_coast_list'),
    path('hotels/packages/selfdrive/', views.package_selfdrive_list, name='package_selfdrive_list'),
