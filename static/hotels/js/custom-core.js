jQuery(function ($) {
  ...
  $(".dropdown-select").on("click", ".dropdown-menu li a", function () {
    ...
    $(this)
      ...
      .html(asSelectOption + ' <span class="caret"></span>');
  });
  ...
  var $airDatepickerRangeStartGeneral = $(
      "#airDatepickerRange-general #dateStart-general"
    ),
    $airDatepickerRangeEndGeneral = $(
      "#airDatepickerRange-general #dateEnd-general"
    );
  ...
  $airDatepickerRangeEndGeneral.datepicker({
    onSelect: function (fd, date) {
      $airDatepickerRangeStartGeneral
        .data("datepicker")
        .update("maxDate", date);
    },
    autoClose: true,
  ...
  var $airDatepickerRangeStartHotel = $(
      "#airDatepickerRange-hotel #dateStart-hotel"
    ),
  ...
  var $airDatepickerRangeStartFlight = $(
      "#airDatepickerRange-flight #dateStart-flight"
    ),
    $airDatepickerRangeEndFlight = $(
      "#airDatepickerRange-flight #dateEnd-flight"
    );
  ...
  var $airDatepickerRangeStartGuide = $(
      "#airDatepickerRange-guide #dateStart-guide"
    ),
  ...
  $('a[data-toggle="tab"]')
    .on("shown.bs.tab", function () {
      $($(this).attr("href"))
        .find(".slick-product-item-in-tab")
        .slick({
          infinite: false,
          slidesToShow: 3,
          slidesToScroll: 1,
  ...
  $('a[data-toggle="tab"]')
    .on("shown.bs.tab", function () {
      $($(this).attr("href"))
        .find(".slick-product-item-in-tab-col-4")
        .slick({
          infinite: false,
          slidesToShow: 4,
          slidesToScroll: 1,
